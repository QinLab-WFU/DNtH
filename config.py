...
_C.DATA.LOG_DIR = './tensorboard_output/'
_C.DATA.TOP_K = -1
...
_C.MODEL.hash_length =16
_C.MODEL.alph_param = 20
_C.MODEL.beta_param = 200
_C.MODEL.margin = 10
...
_C.TRAIN.TRIPLET_STRATEGY='batch_hard'
# -----------------------------------------------------------------------------
